# The Enumerable#each_cons method iterates over the members of a collection taking each 
# sequence of n consecutive elements at a time and passing them to the associated block 
# for processing. It then returns a value of nil.
...
def each_cons(arr)
  ...
  arr[0..-2].each do |_| 
    value1 = arr.fetch(idx1)
    value2 = arr.fetch(idx2)
