# Enumerable#all? processes elements in a collection by passing each element value to a 
# block that is provided in the method call. If the block returns a value of true for every element, 
