...
# Write a method called max_by that behaves similarly for Arrays. It should take an 
# Array and a block, and return the element that contains the largest value.
